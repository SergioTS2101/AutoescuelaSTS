...
public class TemasTeoriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView tema1 = findViewById(R.id.cvTema1);
        CardView tema2 = findViewById(R.id.cvTema2);
        CardView tema3 = findViewById(R.id.cvTema3);
        CardView tema4 = findViewById(R.id.cvTema4);
